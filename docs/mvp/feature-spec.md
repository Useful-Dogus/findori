...
### 3.1 일일 이슈 슬라이드 스트림 발행 (FR-01, FR-02)

목표:

- 장 마감 후 당일 핵심 이슈를 슬라이드 스트림 형태로 자동 발행
...
- 당일 피드에 이슈 묶음이 노출되고 구조/변동 사실/이유/출처가 함께 확인된다
