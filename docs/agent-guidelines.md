...
- TypeScript 5.4+ / Node.js 20+ + `@anthropic-ai/sdk` (기존 설치), `zod` ^4.3 (기존), `@supabase/supabase-js` ^2.0 (기존) (013-claude-card-gen)
- Supabase PostgreSQL — `issues` (cards_data JSONB), `feeds` (기존 테이블, 변경 없음) (013-claude-card-gen)
